		...
		<div id="header">
			<div id="section">
				<div
					...
					<h3>A project by Hardik Nadiyapara</h3>
				</div>
			</div>
			<ul>
			...
			<center>
				<div id="tagline">
					<div>
						<h2 style="height: 0px;">Online Voting System</h2>
						<br> Name: Hardik Nadiyapara<br> ID: 12457<br> Email: <a
							href="mailto:hardik.nadiyapara@gmail.com">hardik.nadiyapara@gmail.com</a>
					</div>
				</div>
			</center>
		</div>
